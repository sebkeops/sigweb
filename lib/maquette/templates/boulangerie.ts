...
export const boulangerie: TemplateConfig = {
  ...
  defaults: {
    ...
    textePresentation:
      'Pas de fioritures. Du levain naturel, des farines locales, et le temps qu\'il faut pour que la pâte développe ses arômes. Notre fournil tourne dès l\'aube pour que vous trouviez chaque jour des baguettes croustillantes, des viennoiseries dorées et des pâtisseries soignées.',
    universSectionTitle: 'Du pain, des viennoiseries, et bien *plus encore*.',
    universSectionIntro:
      'Chaque produit est confectionné à la main, dans notre fournil.',
  ...
  universItems: [
    { cat: 'Spécialité maison', name: 'Pains au levain',       desc: 'Tradition, complet, multi-céréales, seigle. Cuits sur sole.' },
    { cat: 'Du matin',          name: 'Viennoiseries',         desc: 'Croissants, pains au chocolat, brioches. Cuits chaque matin.' },
    { cat: 'Sucré',             name: 'Pâtisseries',           desc: 'Tartes, éclairs, mille-feuilles. Frais du jour.' },
    { cat: 'Sur commande',      name: 'Gâteaux d\'événement',  desc: 'Anniversaires, mariages, baptêmes. Pièces sur mesure.' },
    { cat: 'Pause salée',       name: 'Snacks & sandwichs',    desc: 'Quiches, pizzas, sandwichs frais.' },
  ],

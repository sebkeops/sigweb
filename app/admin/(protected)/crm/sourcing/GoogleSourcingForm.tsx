...
/**
 * Formulaire de sourcing Google (extraction du composant original
 * SourcingPage suite à l'ajout des onglets Google/Sirene — chantier
 * Sirene/PageSpeed Lot 1).
 *
 * IMPORTANT : aucune modification fonctionnelle vs l'ancien SourcingPage.
 * L'extraction sert uniquement à permettre la coexistence des onglets.
 * Le flux Google reste strictement inchangé.
 */
export default function GoogleSourcingForm({ baseCoords }: Props) {

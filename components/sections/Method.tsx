      ...
      <div className="container-narrow">
        <div className="mb-14 text-center">
          ...
          <p className="mt-4 font-body text-base text-muted">
            Mon approche commence toujours par une simulation. Vous voyez le résultat avant de vous
            engager.
          </p>
        </div>
        ...
        <div className="grid gap-6 sm:grid-cols-3">
          {steps.map((step) => (
            ...
            >
              <span className="mb-4 inline-block font-heading text-4xl font-extrabold text-primary-soft">
                {step.num}
              </span>
